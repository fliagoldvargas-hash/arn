...
const phases: RoadmapPhase[] = [
  {
    ...
    body: "NEXA is live. The token launch, website, X presence, documentation, wallet connect, and launch-state modals are in place.",
    milestones: ["Token Launch", "NEXA Website", "X / Twitter Live", "Docs and Roadmap Pages"],
  },
  {
    date: "03 AUG 2026",
    status: "pending",
  ...
  },
  {
    ...
    body: "NEXA begins opening the infrastructure layer for creators to configure agents, connect skills, and prepare automated workflows.",
  ...
  return (
    <main className="roadmap-shell" ref={pageRef}>
      ...
      <section className="roadmap-hero">
        ...
        <p>Each phase unlocks new NEXA capabilities. Track what shipped on 31/07/2026 and what comes next.</p>
      ...
      <section className="roadmap-timeline" aria-label="NEXA roadmap phases">
