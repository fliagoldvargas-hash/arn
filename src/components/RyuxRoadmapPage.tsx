...
const phases: RoadmapPhase[] = [
  {
    ...
    body: "VANTA is live. The token launch, website, X presence, documentation, wallet connect, and launch-state modals are in place.",
    milestones: ["Token Launch", "VANTA Website", "X / Twitter Live", "Docs and Roadmap Pages"],
  },
  {
    date: "EARLY AUG 2026",
    status: "completed",
  ...
  },
  {
    ...
    body: "VANTA begins opening the infrastructure layer for creators to configure agents, connect skills, and prepare automated workflows.",
  ...
  return (
    <main className="roadmap-shell" ref={pageRef}>
      ...
      <section className="roadmap-hero">
        ...
        <p>Each phase unlocks new VANTA capabilities. Track what shipped on 31/07/2026 and what comes next.</p>
      ...
      <section className="roadmap-timeline" aria-label="VANTA roadmap phases">
